...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (messageBox) {
        let msg = window.CONFIG && window.CONFIG.message && window.CONFIG.message !== "__MESSAGE__"
            ? window.CONFIG.message
            : `Valentine này em có anh! Cảm ơn anh đã bước vào thế giới của em theo cách rất đặc biệt. Chỉ mong chúng ta, dù thế nào vẫn luôn bình yên đi cùng nhau ❤`;
